        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="View/create.php">Make your PC</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="View/etemplates.php">Templates</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="View/shop.php">Shop</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="View/account.php">My Account</a>
                    </li>
                </ul>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div id="textCarousel">
                        ...
                        <br>
                        <button type="button" class="btn btn-danger" onclick="location.href='View/create.php'">Create PC</button>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div id="textCarousel2">
                        ...
                        <button type="button" class="btn btn-danger" onclick="location.href='View/templates.php'">Explore</button>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div id="textCarousel3">
                        ...
                        <button type="button" class="btn btn-danger" onclick="location.href='View/shop.php'">Shop</button>
                    </div>
                </div>
            </div>
